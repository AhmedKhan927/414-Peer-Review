...
#  1 The top of the code could have comments explaining the use of each of the imported - Ahmed Khan


#  4 I really like the use of multiple python codefiles in order to organize all the work done segmented. I think it really helps with code readability
#Load data
